      ...
      <div className="flex flex-col items-center justify-center h-full blur-content">
        <div className="bg-white p-8 rounded-lg w-full max-w-md text-center">
          ...
          <form className="space-y-4">
            ...
            />
            <button
              className="w-full bg-[#007AFF] text-white py-2 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
              type="submit"
            >
              Reset Password
            </button>
          ...
          <p className="mt-4 text-gray-600">
            Back to&nbsp;
            <a className="text-[#007AFF] hover:underline" href="/">
              log in
            </a>
          </p>
        </div>
