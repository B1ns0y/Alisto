    ...
    <div className="flex min-h-screen">
      ...
      >
        <div className="text-center">
          ...
          <Link to="/register">
          <button
            className="text-[16.91px] mt-2 mb-14 w-[311.6000061035156px] py-2 border-2 border-blue-300 text-[#007AFF] rounded">
            Register
          </button>
          </Link>
        </div>
        ...
        <div className="w-2/3 flex flex-col items-center">
          ...
          <form className="w-full">
            ...
            <div className="mb-4 text-center">
              <a className="text-black-600" href="/set-password">Forgot Password?</a>
            </div>
            <button className="text-[16px] w-full px-4 py-2 bg-[#007AFF] text-white rounded">Login</button>
          </form>
        </div>
      </div>
    </div>
